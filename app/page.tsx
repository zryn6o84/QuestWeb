...
import { Bot, Shield, Rocket, Eye, Users, Share, Sparkles } from "lucide-react";
...
const USE_CASES = [
  ...
  },
  {
    ...
    features: [
      "Create collaborative study groups and track learning progress within the QuestWeb platform",
...
const FEATURES = [
  {
    title: "Quick Launch",
    description: "Create community reward activities in minutes. Streamlined process for setting up QuestWebs, defining tasks, and managing rewards - all in one place.",
    icon: Rocket
  },
  {
    title: "AI Review",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative h-[600px] w-full">
        ...
        <div className="relative container mx-auto h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-base md:text-xl text-gradient-secondary max-w-3xl mb-6 md:mb-8 animate-fade-in-delay">
            A platform revolutionizing community engagement and task
            management for Web3. Create, manage, and participate in bounty tasks with
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
          {FEATURES.map((feature, index) => (
            <div key={index} className="glass-card p-4 md:p-8 rounded-2xl">
              <div className="h-12 w-12 md:h-16 md:w-16 mx-auto mb-4 md:mb-6 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center">
                <feature.icon className="h-6 w-6 md:h-8 md:w-8 text-white" />
              </div>
              <h2 className="text-xl md:text-2xl font-bold mb-3 md:mb-4 text-gradient-secondary">
                {feature.title}
              </h2>
      ...
      <footer className="mt-auto py-4 md:py-6 text-center text-xs md:text-sm text-gray-400">
        <p>© 2024 QuestWeb. All rights reserved.</p>
      </footer>
    </div>
  );
}
